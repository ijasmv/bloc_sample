...
/// @nodoc
mixin _$SearchState {
  List<SearchResultData> get result => throw _privateConstructorUsedError;
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      {required final List<SearchResultData> result,
  ...
  final List<SearchResultData> _result;
  @override
  List<SearchResultData> get result {
  ...
  @override
  String toString() {
    return 'SearchState(result: $result, idleList: $idleList, isLoading: $isLoading, isError: $isError)';
  }
